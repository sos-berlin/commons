...
public class JoeTest {
    ...
    public void testWriteJSObjEdit() throws IOException {
        ...
        JoeObjectStatus objVersionStatus = new JoeObjectStatus();
        objVersionStatus.setDeployed(true);
        objVersionStatus.setVersionState(VersionStateText.LIVE_IS_NEWER);
        jsObjectEdit.setObjectVersionStatus(objVersionStatus); 
