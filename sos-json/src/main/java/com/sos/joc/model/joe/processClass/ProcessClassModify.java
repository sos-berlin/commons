...
public class ProcessClassModify {
    ...
    private ProcessClassConfiguration processClass;
    ...
    @JsonProperty("processClass")
    @JacksonXmlProperty(localName = "process_class", isAttribute = false)
    public ProcessClassConfiguration getProcessClass() {
        return processClass;
    }
    ...
    @JsonProperty("processClass")
    @JacksonXmlProperty(localName = "process_class", isAttribute = false)
    public void setProcessClass(ProcessClassConfiguration processClass) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProcessClassModify) == false) {
            return false;
        }
        ProcessClassModify rhs = ((ProcessClassModify) other);
