...
@JacksonXmlRootElement(localName = "jobs_wizard_filter")
@JsonPropertyOrder({
    "jobschedulerId",
    "isOrderJob"
})
public class JobsWizardFilter {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof JobsWizardFilter) == false) {
            return false;
        }
        JobsWizardFilter rhs = ((JobsWizardFilter) other);
