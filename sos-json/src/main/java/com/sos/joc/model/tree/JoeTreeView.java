...
public class JoeTreeView {
    ...
    private List<JoeTree> folders = new ArrayList<JoeTree>();
     ...
     */
    @JsonProperty("folders")
    public List<JoeTree> getFolders() {
        return folders;
    }
     ...
     */
    @JsonProperty("folders")
    public void setFolders(List<JoeTree> folders) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof JoeTreeView) == false) {
            return false;
        }
        JoeTreeView rhs = ((JoeTreeView) other);
