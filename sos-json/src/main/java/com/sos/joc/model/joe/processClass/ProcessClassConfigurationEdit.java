...
@JacksonXmlRootElement(localName = "process_class_configuration_edit")
...
public class ProcessClassConfigurationEdit {
    ...
    private ProcessClassConfiguration configuration;
    /**
     * auditParams
     * <p>
     * 
    ...
    @JsonProperty("configuration")
    @JacksonXmlProperty(localName = "configuration", isAttribute = false)
    public ProcessClassConfiguration getConfiguration() {
    ...
    @JsonProperty("configuration")
    @JacksonXmlProperty(localName = "configuration", isAttribute = false)
    public void setConfiguration(ProcessClassConfiguration configuration) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProcessClassConfigurationEdit) == false) {
            return false;
        }
        ProcessClassConfigurationEdit rhs = ((ProcessClassConfigurationEdit) other);
