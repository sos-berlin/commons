                    ...
                    for (int k = 0; k < cAtr.getLength(); k++) {
                        if (cAtr.item(k).getNodeName().equalsIgnoreCase("itemId")) {
                            ...
                            if (item_ != null && item_.getValue() != null && item_.getValue().length() > 0) {
                                ...
                                String newValue = sosString.parseToString(newItem.getValue()).trim().length() == 0 ? sosString.parseToString(newItem
                                        .getDefaults()) : sosString.parseToString(newItem.getValue());
