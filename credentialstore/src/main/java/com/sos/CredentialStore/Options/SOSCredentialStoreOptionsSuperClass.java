...
public class SOSCredentialStoreOptionsSuperClass extends JSOptionsClass {
    ...
    public SOSOptionString CredentialStore_AuthenticationMethod = new SOSOptionString(this, CLASSNAME + ".CredentialStore_AuthenticationMethod", "", 
            "privatekey", "privatekey", true);
    public SOSOptionString CS_AuthenticationMethod = (SOSOptionString) CredentialStore_AuthenticationMethod.SetAlias(CLASSNAME + ".CS_AuthenticationMethod");
    ...
    public SOSOptionBoolean CredentialStore_DeleteExportedFileOnExit = new SOSOptionBoolean(this, CLASSNAME + ".CredentialStore_DeleteExportedFileOnExit",
            "", "true", "true", false);
    public SOSOptionBoolean CS_DeleteExportedFileOnExit = (SOSOptionBoolean) CredentialStore_DeleteExportedFileOnExit.SetAlias(CLASSNAME
    ...
    @JSOptionDefinition(name = "CredentialStore_ExportAttachment", description = "", key = "CredentialStore_ExportAttachment", type = "SOSOptionBoolean",
            mandatory = false)
    public SOSOptionBoolean CredentialStore_ExportAttachment = new SOSOptionBoolean(this, CLASSNAME + ".CredentialStore_ExportAttachment", "", "false", "false",
            false);
    public SOSOptionBoolean CS_ExportAttachment = (SOSOptionBoolean) CredentialStore_ExportAttachment.SetAlias(CLASSNAME + ".CS_ExportAttachment");
    ...
    public SOSOptionOutFileName CredentialStore_ExportAttachment2FileName = new SOSOptionOutFileName(this, CLASSNAME + ".CredentialStore_ExportAttachment2FileName",
            "", " ", " ", false);
    public SOSOptionOutFileName CS_ExportAttachment2FileName = (SOSOptionOutFileName) CredentialStore_ExportAttachment2FileName.SetAlias(CLASSNAME
    ...
    public SOSOptionInFileName CredentialStore_FileName = new SOSOptionInFileName(this, CLASSNAME + ".CredentialStore_FileName", "", " ", " ", true);
    public SOSOptionInFileName CS_FileName = (SOSOptionInFileName) CredentialStore_FileName.SetAlias(CLASSNAME + ".CS_FileName");
    ...
    @JSOptionDefinition(name = "CredentialStore_KeyFileName", description = "", key = "CredentialStore_KeyFileName", type = "SOSOptionInFileName",
            mandatory = false)
    public SOSOptionInFileName CredentialStore_KeyFileName = new SOSOptionInFileName(this, CLASSNAME + ".CredentialStore_KeyFileName", "", " ", " ", false);
    public SOSOptionInFileName CS_KeyFileName = (SOSOptionInFileName) CredentialStore_KeyFileName.SetAlias(CLASSNAME + ".CS_KeyFileName");
    ...
    public SOSOptionString CredentialStore_KeyPath = new SOSOptionString(this, CLASSNAME + ".CredentialStore_KeyPath", "", " ", " ", true);
    public SOSOptionString CS_KeyPath = (SOSOptionString) CredentialStore_KeyPath.SetAlias(CLASSNAME + ".CS_KeyPath");
    ...
    @JSOptionDefinition(name = "CredentialStore_OverwriteExportedFile", description = "", key = "CredentialStore_OverwriteExportedFile", type = "SOSOptionBoolean",
            mandatory = false)
    public SOSOptionBoolean CredentialStore_OverwriteExportedFile = new SOSOptionBoolean(this, CLASSNAME + ".CredentialStore_OverwriteExportedFile", "", "true",
            "true", false);
    public SOSOptionBoolean CS_OverwriteExportedFile = (SOSOptionBoolean) CredentialStore_OverwriteExportedFile.SetAlias(CLASSNAME
    ...
    public SOSOptionString CredentialStore_Permissions4ExportedFile = new SOSOptionString(this, CLASSNAME + ".CredentialStore_Permissions4ExportedFile", "", 
            "600", "600", false);
    public SOSOptionString CS_Permissions4ExportedFile = (SOSOptionString) CredentialStore_Permissions4ExportedFile.SetAlias(CLASSNAME
    ...
    @JSOptionDefinition(name = "CredentialStore_ProcessNotesParams", description = "", key = "CredentialStore_ProcessNotesParams", type = "SOSOptionBoolean",
            mandatory = false)
    public SOSOptionBoolean CredentialStore_ProcessNotesParams = new SOSOptionBoolean(this, CLASSNAME + ".CredentialStore_ProcessNotesParams", "", "false", "false",
            false);
    public SOSOptionBoolean CS_ProcessNotesParams = (SOSOptionBoolean) CredentialStore_ProcessNotesParams.SetAlias(CLASSNAME + ".CS_ProcessNotesParams");
    ...
    public SOSOptionString CredentialStore_StoreType = new SOSOptionString(this, CLASSNAME + ".CredentialStore_StoreType", "", "KeePass", "KeePass", false);
    public SOSOptionString CS_StoreType = (SOSOptionString) CredentialStore_StoreType.SetAlias(CLASSNAME + ".CS_StoreType");
    ...
    public SOSOptionPassword CredentialStore_password = new SOSOptionPassword(this, CLASSNAME + ".CredentialStore_password", "", " ", " ", false);
    public SOSOptionPassword CS_password = (SOSOptionPassword) CredentialStore_password.SetAlias(CLASSNAME + ".CS_password");
    ...
    public SOSOptionBoolean use_credential_Store = new SOSOptionBoolean(this, CLASSNAME + ".use_credential_Store", "", "false", "false", false);
