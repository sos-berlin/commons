...
public class CredentialStoreKeyNotFound extends SOSCredentialStoreException {
    ...
    public CredentialStoreKeyNotFound(final SOSCredentialStoreOptions pobjOptions) {
        super(String.format("SOSVfsCS_E_001: Entry '%1$s' in database '%2$s' not found", pobjOptions.credentialStoreKeyPath.getValue(),
                pobjOptions.credentialStoreFileName.getValue()));
