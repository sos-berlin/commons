 ...
 */
package com.sos.CredentialStore.KeePass.pl.sind.keepass.kdb.v1;
...
import com.sos.CredentialStore.KeePass.pl.sind.keepass.crypto.Cipher;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.crypto.CipherException;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.crypto.CipherFactory;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.exceptions.DecryptionFailedException;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.exceptions.KeePassDataBaseException;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.exceptions.UnsupportedDataBaseException;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.hash.Hash;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.hash.HashFactory;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.kdb.KeePassConst;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.kdb.KeePassDataBase;
import com.sos.CredentialStore.KeePass.pl.sind.keepass.util.Utils;

/** KDB file database format reader. Supports password, keyfile and
 * password+keyfile database access.
 * 
...
public class KeePassDataBaseV1 implements KeePassDataBase {
    ...
    @Override
    public void setKeyFile(final InputStream keyFile) throws KeePassDataBaseException {
        if (keyFile != null) {
            try {
    ...
    public Entry getEntry(final String pstrPath) {
        ...
        if (strEntryName.startsWith("/")) {
            strEntryName = pstrPath.substring(1);
        }
        if (strEntryName.contains("/")) {
            String[] strA = strEntryName.split("/");
