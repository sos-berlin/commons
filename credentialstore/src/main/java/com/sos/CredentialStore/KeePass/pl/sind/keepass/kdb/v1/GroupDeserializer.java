...
public class GroupDeserializer {
    ...
    public void readField(final short fieldType, final int fieldSize, final ByteBuffer data) throws UnsupportedEncodingException {
        switch (fieldType) {
        case 0x0000:
            // Invalid or comment block
            comments.add(new Field(fieldType, fieldSize, fieldSize, data));
            break;
        case 0x0001:
            // Group ID, FIELDSIZE must be 4 bytes; It can be any
            // 32-bit value except 0 and 0xFFFFFFFF
        ...
        case 0x0002:
            ...
            break;
        case 0x0003:
            // Creation time, FIELDSIZE = 5, FIELDDATA = packed
            // date/time
            creationTime = new DateField(fieldType, fieldSize, data);
            break;
        case 0x0004:
            // Last modification time, FIELDSIZE = 5, FIELDDATA =
            // packed date/time
            lastModificationTime = new DateField(fieldType, fieldSize, data);
            break;
        case 0x0005:
            // Last access time, FIELDSIZE = 5, FIELDDATA = packed
            // date/time
            lastAccessTime = new DateField(fieldType, fieldSize, data);
            break;
        case 0x0006:
            // Expiration time, FIELDSIZE = 5, FIELDDATA = packed
            // date/time
        ...
        case 0x0009:
            ...
            break;
        default:
            // Group entry terminator, FIELDSIZE must be 0
    ...
    public Group getGroup() {
        ...
        if (intLevel > intLastLevel) {
            ...
            if (intLevel < intLastLevel) {
                ...
                if (intLevel == intLastLevel && intLastLevel != 0) {
                    objG.setParent(objGStack.peek());
                }
            }
        }
