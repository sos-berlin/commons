 ...
 * </p>
 * <p>
 * Description: Implementation of SOSConnection for DB2
 * </p>
 * <p>
...
public class SOSDB2Connection extends sos.connection.SOSConnection implements SequenceReader {
     ...
     * comply with procedural statements Oracle ends PL/SQL statements with / in
     * a separate line MySQL ends procedural statements with \g in a separate
     * line
     * 
     ...
     * @return true if all procedural statements need endSB, or false if only
     *         statements with END; (e.g. functions) need endSB
     * @throws Exception */
