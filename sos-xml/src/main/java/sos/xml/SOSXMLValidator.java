 ...
 * </p>
 * <p>
 * Description: Die Struktur des Schemas wird in der Datenbank abgebildet
 * </p>
 * Dieses Programm interpretiert ein XSD-Schema und erzeugt ein Insert Script.
 * Sechs Parametern müssen übergeben werden. 1. Parameter: Pfad + Name der
 * XSD-Datei 2. Parameter: Content_ID (M, S oder P) 3. Parameter: Pfad + Name
 * der script Datei, der hier erzeugt werden soll 4. Parameter: ini-Datei, in
 * der die DB-Einstellungen stehen . 5. Parameter: CONTENT_TABLENAME = movement,
 * stock oder price. 6. Parameter: Richtung der Datenstrom (INBOUND oder
...
public class SOSXMLValidator implements ContentHandler, ErrorHandler, DTDHandler, EntityResolver {
    ...
    /** Validiert die übergebene XML-Datei. Ist die übergebene XML-Datei nicht
     * valide, dann wird eine Exception ausgelöst.
     * 
     * @param fileName
     * @throws Exception */
    ...
    /** Validiert die übergebene InputSource. Ist sie nicht valide, dann wird
    ...
    public static void main(String[] args) throws Exception {
         ...
         * "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?> <familie>  <vater/>  <mutter/>  <kinder/></familie>"
         * ; System.out.println(xmlString); java.io.StringReader reader = new
         * java.io.StringReader(xmlString); InputSource i = new
         * InputSource(reader); validator = new SOSXMLValidator();
         * //validator.validate(i,
         * "http://www.deutschebkk.de/schema/2005/InsuredPersonDocument J:/E/java/mo/axis/schema.insured_person/InsuredPersonDocument.xsd"
         * ); validator.validate(i, "C:/temp/a.xsd"); } catch (Exception e) {
