...
public class SOSProfileSettings extends sos.settings.SOSSettings {
		...
		try {
			...
			while (true) {
				...
				if (line == null)
					break;
				/**
				 * if a line in the ini file ends with \r (e.g. file comes form windows in binary format)
				 * then the regexp is not able to match.
				 * Due to the fact that we don't need the \r in the value field as well we
				 * discard it here from the input line.
				 * kb 2014-02-14
				 */
	 ...
	 */
	@Override public String getSectionEntry(final String entry) throws Exception {
		try {
	 ...
	 */
	@Override public Properties getSection(final String section) throws Exception {
		try {
	 ...
	 * @see #getSection( String )
	 */
	@Override public Properties getSection() throws Exception {
		try {
	 ...
	 * @see #getSection( String )
	 */
	@Override public Properties getSection(final String application, final String section) throws Exception {
		try {
	 ...
	 * @throws java.lang.Exception
	 */
	@Override public ArrayList<String> getSections() throws Exception {
		return sections;
	}
	 ...
	 */
	@Override public void setKeysToLowerCase() throws Exception {
		if (logger != null)
	 ...
	 */
	@Override public void setKeysToUpperCase() throws Exception {
		if (logger != null)
			logger.debug3("calling " + SOSClassUtil.getMethodName());
		if (logger != null)
	 ...
	 * @param ignoreCase
	 */
	@Override public void setIgnoreCase(final boolean ignoreCase) {
	 ...
	 * @param ignoreCase
	 */
	@Override public boolean getIgnoreCase() {
		return ignoreCase;
	}
}
