...
/** Title: SOSConnectionSettings Description: eine einfache Klasse zum Lesen
 * einer settings-Tabelle Copyright: Copyright (c) 2003 Company: SOS Berlin GmbH
 * 
...
public class SOSConnectionSettings extends sos.settings.SOSSettings {
    ...
    /** Konstruktor
     * 
     * @param sosConnection ein SOSConnection-Objekt
     * @param source Name der Tabelle für Einstellungen
     * @throws Exception
    ...
    /** @param sosConnection DBConnection
     * @param source Name der Tabelle
     ...
     * 
     * @param String application Name der Anwendung
    ...
    public boolean initSequence(String application, String section, String entry, String createdBy) throws Exception {
        ...
        try {
            ...
            try {
                if (this.ignoreCase) {
                    query = new StringBuffer("SELECT \"").append(VALUE).append("\" FROM ").append(source).append(" WHERE %lcase(\"").append(APPLICATION).append("\") = '").append(application.toLowerCase()).append("' AND %lcase(\"").append(SECTION).append("\") = '").append(section.toLowerCase()).append("' AND %lcase(\"").append(NAME).append("\") = '").append(entry.toLowerCase()).append("'");
                } else {
                    query = new StringBuffer("SELECT \"").append(VALUE).append("\" FROM ").append(source).append(" WHERE \"").append(APPLICATION).append("\" = '").append(application).append("' AND \"").append(SECTION).append("\" = '").append(section).append("' AND \"").append(NAME).append("\" = '").append(entry).append("'");
                }
     ...
     * 
     * @exception Exception wird ausgelöst falls ein Datenbankfehler vorliegt. */
    ...
    public int getLockedSequence(String application, String section, String entry) throws Exception {
        ...
        try {
            ...
            if (this.ignoreCase) {
                query = new StringBuffer("SELECT \"").append(VALUE).append("\" FROM ").append(source).append(" ").append(updlock_from).append(" WHERE %lcase(\"").append(APPLICATION).append("\") = '").append(application.toLowerCase()).append("' AND %lcase(\"").append(SECTION).append("\") = '").append(section.toLowerCase()).append("' AND %lcase(\"").append(NAME).append("\") = '").append(entry.toLowerCase()).append("' ").append(updlock_where);
            } else {
                query = new StringBuffer("SELECT \"").append(VALUE).append("\" FROM ").append(source).append(" ").append(updlock_from).append(" WHERE \"").append(APPLICATION).append("\" = '").append(application).append("' AND \"").append(SECTION).append("\" = '").append(section).append("' AND \"").append(NAME).append("\" = '").append(entry).append("' ").append(updlock_where);
            }
            ...
            if (this.ignoreCase) {
                query = new StringBuffer("UPDATE ").append(source).append(" SET \"").append(VALUE).append("\"=%cast(%cast(\"").append(VALUE).append("\" integer)+1 varchar) WHERE %lcase(\"").append(APPLICATION).append("\") = '").append(application.toLowerCase()).append("' AND %lcase(\"").append(SECTION).append("\") = '").append(section.toLowerCase()).append("' AND %lcase(\"").append(NAME).append("\") = '").append(entry.toLowerCase()).append("'");
            } else {
                query = new StringBuffer("UPDATE ").append(source).append(" SET \"").append(VALUE).append("\"=%cast(%cast(\"").append(VALUE).append("\" integer)+1 varchar) WHERE \"").append(APPLICATION).append("\" = '").append(application).append("' AND \"").append(SECTION).append("\" = '").append(section).append("' AND \"").append(NAME).append("\" = '").append(entry).append("'");
            }
     ...
     * 
     * @param entryCounterApplication Name der Applikation für Zählervariablen.
     *            Default : counter */
     ...
     * 
     * @param entryCounterSection Name der Sektion für Zählervariablen. Default
     *            : counter */
     ...
     * 
     * @param entryOrder Sortierfeld(er) für Anzeige der Einträge. Default :
     *            NAME */
     ...
     * 
     * @param entrySchemaSection Name der Sektion für Master Schemata. Default :
     *            **schema** */
     ...
     * 
     * @param entrySettingTitle Feld für Titels der Einträge. */
