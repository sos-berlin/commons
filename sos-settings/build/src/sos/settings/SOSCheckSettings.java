...
/**
 * 
 * Diese Klasse interpretiert boolische Ausdrücke.
 * Die Boolischen Ausdrücke bestehen aus den Operanten = "and" und "or". Die Klein- und Großschreibung
 * der Operanten ist unwichtig.
 * 
 * 
 * ***************************************************************************
 * ***************************************************************************
...
public class SOSCheckSettings {
	...
	/**
	 * Konstruktor
	 * @param String source_ -> Pfad und Name der Konfigurationsdatei zu der Sektion mandantory.
	 * @param SOSLogger Objekt
	 *   
	 */
	/*public SOSCheckSettings(String source_, HashMap values_, SOSLogger logger_) throws Exception {
	 try {
	 source = source_;
	 this.values = values_;
	 logger =logger_;
...
//			allgemein 
	...
	public boolean process() throws Exception {
		...
		try {
			...
			logger.debug("..Pflichtfelder zum Auswerten ist: " + condition);
			logger.debug("..entspricht : " + hCond);                                                
			hCond = hCond.trim();
			...
			logger.debug("..ergebnis ist : " + retVal);
			return retVal;
		} catch (Exception e){
			throw new Exception ("\n -> error in " + SOSClassUtil.getMethodName() + " " + e); 
		}
