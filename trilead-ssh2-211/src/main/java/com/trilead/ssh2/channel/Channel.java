...
public class Channel
{
	...
	public static int CHANNEL_BUFFER_SIZE = 30000;
	...
	public Channel(final ChannelManager cm)
	{
		...
		localWindow = CHANNEL_BUFFER_SIZE;
//		this.localMaxPacketSize = 35000 - 1024; // leave enough slack
		localMaxPacketSize = CHANNEL_BUFFER_SIZE + 5000 - 1024; // leave enough slack

		stdinStream = new ChannelOutputStream(this);
		stdoutStream = new ChannelInputStream(this, false);
		stderrStream = new ChannelInputStream(this, true);
	}
