...
public class TestJobSchedulerDate {
    ...
    @Test
    public void testGetDateFromDateFrom() throws SOSInvalidDataException   {
        Date d = new Date();
    ...
    @Test
    public void testGetDateFromDateTo() throws SOSInvalidDataException {
        Date d = new Date();
        String timeZone = "UTC";
        String date = "6d-02";
    ...
    @Test
    public void testInstantFromISO8601StringWithOnlyTime() {
    ...
    @Test
    public void testGetInstantFromDateStr() throws SOSInvalidDataException {
