...
public class SOSPrefixLogger extends SOSStandardLogger implements Serializable {
     ...
     * @param logLevel
     * @throws Exception */
    public SOSPrefixLogger(SOSStandardLogger logger, int logLevel, String prefix) throws Exception {
     ...
     * @param logLevel
     * @throws Exception */
    public SOSPrefixLogger(SOSStandardLogger logger, int logLevel) throws Exception {
        super(logger.getWriter(), logLevel);
    }

    /** @param logger
     * @throws Exception */
    public SOSPrefixLogger(SOSStandardLogger logger) throws Exception {
