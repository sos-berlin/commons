...
public class SOSTree {
    ...
    private String printNodeContent(SOSTreeElement node, int level) throws Exception {
        ...
        try {
            ...
            StringBuilder out = new StringBuilder();
            if (_subTables) {
                out.append("<tr class=\"").append((_disabled ? "dis" : "")).append(_cssClass).append("\"><td colspan=\"10\" class=\"").append((_disabled ? "dis" : "")).append(_cssClass
                       ).append("\"><table class=\"").append((_disabled ? "dis" : "")).append(_cssClass).append("\">");
            }
            while (current != null) {
    ...
    private String formatElement(SOSTreeElement element, String indent) {
        ...
        str.append("<tr class=\"").append((_disabled ? "dis" : "")).append(cssClass).append("\"><td class=\"").append((_disabled ? "dis" : "")).append(cssClass)
            .append("\"").append(((_tdWidth != null) ? " width=\"" + _tdWidth + "\"" : "")).append(">").append(indent);
