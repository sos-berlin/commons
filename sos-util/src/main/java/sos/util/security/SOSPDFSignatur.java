...
public class SOSPDFSignatur {
    ...
    public static void createSignatur(PrivateKey privateKey, Certificate[] chain, String originalPdfName, String outputPdfName) throws Exception {
        ...
        // setCrypto(PrivateKey privKey, Certificate[] certChain, CRL[] crlList,
        // PdfName filter)
        // CRL - certificate revocation lists (CRLs) that have different formats
        // but important common uses.
        // For example, all CRLs share the functionality of listing revoked
        // certificates, and can be queried on whether or not they list a given
        // certificate.
        // PdfName
        ...
        // sap.setCrypto(privateKey, chain,
        ...
        if (SOSPDFSignatur.visible) {// todo
            // sap.setVisibleSignature(new Rectangle(200, 200, 400, 400), 1,
            // null);
        }
