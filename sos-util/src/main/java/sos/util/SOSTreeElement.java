...
public class SOSTreeElement {
    ...
    /** URL des Imageverzeichnisses - bei ungleich null wird die des Baumes
     * &uuml;berschrieben */
    private String _imgDir = null;
    /** Icon f&uuml;r einen offenen Knoten - bei ungleich null wird der des
     * Baumes &uuml;berschrieben */
    private String _imgOpenNode = null;
    /** Icon f&uuml;r einen geschlossenen Knoten - bei ungleich null wird der des
     * Baumes &uuml;berschrieben */
    private String _imgCloseNode = null;
    /** Icon f&uuml;r ein Blatt - bei ungleich null wird der des Baumes
     * &uuml;berschrieben */
    ...
    /** F&uuml;gt ein Element auf der gleichen Ebenen an das Ende der Liste
     * hinzu.
     *
    ...
    /** Speichert/&Uuml;berschreibt einen Parameter, der an die URLs
     * angeh&auml;gt wird.
     *
    ...
    /** Setzt das erste Element der darunter liegenden Liste. Nur als
     * Knotenelement m&ouml;glich!
     *
    ...
    /** Setzt den Titel des Elementes. Dies ist der Text, der in dem Baum
     * angezeigt wird.
     *
    ...
    /** Setzt das Knotenelement auf offen/geschlossen. Nur als Knotenelement
     * m&ouml;glich!
     *
    ...
    /** Setzt die URL des Elementes. Evtl. Parameter werden automatisch
     * angef&uuml;gt. Ist dies ein Knotenelement, dann wird diese URL nicht
     * beachtet, wenn die Knoten auch &uuml;ber den Titel ge&ouml;ffnet werden.
     *
     * @param url URL */
    ...
    /** Setzt den Prefix des Elementes. Dieser kann aus HTML bestehen und wird
     * nach dem Icon und vor dem Titel eingef&uuml;gt.
     *
     * @param prefix Prefix */
    ...
    /** Setzt den Postfix des Elementes. Dieser kann aus HTML bestehen und wird
     * nach dem Titel in eine neue Tabellenspalte eingef&uuml;gt.
     *
    ...
    /** Setzt den Bildnamen f&uuml;r ein offenes Knotenelement. Ist dieser
     * ungleich null, so &uuml;schreibt er den default Wert des Baumobjektes.
     *
     * @param img Bildname */
    ...
    /** Setzt den Bildnamen f&uuml;r ein geschlossenes Knotenelement. Ist dieser
     * ungleich null, so &uuml;schreibt er den default Wert des Baumobjektes.
     *
     * @param img Bildname */
    ...
    /** Setzt den Bildnamen f&uuml;r ein Blattelement. Ist dieser ungleich null,
     * so &uuml;schreibt er den default Wert des Baumobjektes. Wird ein leerer
