 ...
 * </p>
 * <p>
 * Description: Methoden zum Sortieren werden hier zur Verfügung gestellt
 * </p>
 * <p>
...
public class SOSSort {
    ...
    /** Sortiert eine Array von String in absteigender bzw. aufsteigender
     * Reihenfolge.
     * 
     * desc boolean = true ist für das Aufsteigende Sortierung desc boolean =
     * false ist für das Absteigende Sortierung
     * 
    ...
    public static String[] sortArrayOfString(String[] a, boolean desc) throws Exception {
        String[] aa = null; // Hilfsvariable, wenn absteigen Sortiert werden
                            // soll
     ...
     * |-> HashMap (name=Schmidt;vorname=Hans;gebdatum="01.01.2004");<br>
     * 
     * Achtung: Bytesortierung-> z.B. keyvalue="Günther" kommt vor
     * keyvalue="andrea"
     * 
     * @param list -> unsortierte Arrayliste. Ein Eintrag der ArrayListe besteht
     *            aus einen HashMap.
